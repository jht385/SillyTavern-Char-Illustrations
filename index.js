...
function openImagePickerModal(item, onSelect) {
    ...
    pickerModal.onclick = (e) => {
        if (e.target === pickerModal || e.target.classList.contains('ci-picker-backdrop')) closePicker();
    };
...
function openManageImagesModal(item, onUpdated) {
    ...
    manageModal.onclick = (e) => {
        if (e.target === manageModal || e.target.classList.contains('ci-manage-backdrop')) closeManageModal();
    };
